...
from .views import (
    ...
    get_responses, submit_response, practice_test, get_practice_responses, practice_countdown, practice_transition, 
    test_complete, doctor_dashboard, doctor_logout_view, doctor_newtest, doctor_results, doctor_statistics, doctor_test_page, 
